...
const productsData = [
  ...
  { 'product_id': 84, 'name': "Mistletoe This well-known parasite and killer of trees was revered by the Druids, who would go out and gather it with great ceremony. Youths would go about with it to announce the new year. Eventually more engaging customs were attached to the strange plant, and we're here to see that they continue with these cool Christmas T-shirts.", 'price': 19.00, 'discounted_price': 17.99, 'image': 'mistletoe.gif', 'image_2': 'mistletoe-2.gif', 'thumbnail': 'mistletoe-thumbnail.gif', 'display': 3 },
